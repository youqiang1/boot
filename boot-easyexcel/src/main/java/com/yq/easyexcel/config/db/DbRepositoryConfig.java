package com.yq.easyexcel.config.db;
...
@EnableJpaRepositories(
        basePackages = {"com.yq.easyexcel.repository"})
@EntityScan(basePackages = {"com.yq.easyexcel.db", "org.springframework.data.jpa.convert.threeten"})
